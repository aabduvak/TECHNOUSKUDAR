...
/* harmony import */ var _modules_videoPlayer__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/videoPlayer */ "./src/assets/js/modules/videoPlayer.js");
/* harmony import */ var _modules_menu__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/menu */ "./src/assets/js/modules/menu.js");
/* harmony import */ var _modules_forms__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/forms */ "./src/assets/js/modules/forms.js");
...
window.addEventListener("DOMContentLoaded", function () {
  try {
    new _modules_videoPlayer__WEBPACK_IMPORTED_MODULE_0__["default"]('.play', '.overlay').init();
    new _modules_forms__WEBPACK_IMPORTED_MODULE_2__["default"]().init();
    new _modules_slider__WEBPACK_IMPORTED_MODULE_3__["default"]('.blocks-gallery-item', 4000).init();

    if (document.querySelector('.promo')) {
      new _modules_menu__WEBPACK_IMPORTED_MODULE_1__["default"]('.promo .hamburger', '.promo .menu', '.promo .menu__close', '.promo .menu__overlay').init();
    } else {
      new _modules_menu__WEBPACK_IMPORTED_MODULE_1__["default"]('.other-header .hamburger', '.other-header .menu', '.other-header .menu__close', '.other-header .menu__overlay').init();
    }
  } catch (e) {}
});
...
/* harmony import */ var _services_requests__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../services/requests */ "./src/assets/js/services/requests.js");
...
var Forms = /*#__PURE__*/function () {
  function Forms() {
    ...
    this.form = document.querySelectorAll('form'), this.inputs = document.querySelectorAll('input'), this.comments = document.querySelectorAll('[name="message"]'), this.message = {
      loading: 'Yükleniyor...',
  ...
  _createClass(Forms, [{
    key: "formsending",
    value: function formsending() {
      var _this = this;

      var path = 'assets/contact-form-handler.php';
      ...
      this.form.forEach(function (item) {
        item.addEventListener('submit', function (e) {
          ...
          Object(_services_requests__WEBPACK_IMPORTED_MODULE_4__["postData"])(api, formData).then(function (res) {
            textMessage.textContent = _this.message.success;
          }).catch(function () {
            textMessage.textContent = _this.message.error;
          }).finally(function () {
            clearInputs();
            setTimeout(function () {
...
var Menu = /*#__PURE__*/function () {
  function Menu(trigger, selector, close, overlay) {
  ...
  _createClass(Menu, [{
    ...
    key: "btnTriggerBind",
    value: function btnTriggerBind(selector, trigger) {
      var _this = this;

      trigger.addEventListener('click', function () {
        document.body.classList.add('modal-open');
        document.body.style.marginRight = "".concat(_this.scroll, "px");
    ...
    key: "closeMenu",
    value: function closeMenu(selector) {
    ...
    key: "btnCloseBind",
    value: function btnCloseBind(selector, close, overlay) {
      var _this2 = this;

      close.addEventListener('click', function (e) {
        _this2.closeMenu(selector);
      });
  ...
  _createClass(Sliders, [{
    ...
    value: function activeAnimation() {
      ...
      this.paused = setInterval(function () {
        ...
        _this.slides[_this.slideIndex - 1].classList.remove('animate__slideInRight');

        _this.slides[_this.slideIndex - 1].classList.add('animate__slideInLeft');
      }, this.time);
    }
  }, {
    key: "init",
...
var VideoPlayer = /*#__PURE__*/function () {
  ...
  _createClass(VideoPlayer, [{
    ...
    value: function closeModal() {
      ...
      this.overlay.addEventListener('click', function (e) {
        if (e.target === _this.overlay) {
          _this.closeModal(_this.overlay);
        }
      });
      document.body.classList.remove('modal-open');
      document.body.style.marginRight = "0px";
    ...
    value: function openModal() {
      ...
      document.body.classList.add('modal-open');
      document.body.style.marginRight = "".concat(this.scroll, "px");
    }
  }, {
    key: "bindTriggerBtn",
    value: function bindTriggerBtn() {
      var _this2 = this;
